...
This MVP-O aims to build an Observer monitoring solution intended to offer a global **metrics**
...
_This MVP-0 builds a base for an Observer monitoring solution intended to become an **SCS product**
in the future versions, once it attains sufficient stability._

The current MVP-0 implements the initial iteration of the Observer monitoring solution,
deployed in the Kubernetes cluster, subsequently referred to as the Observer cluster.
As illustrative examples of how this monitoring solution can be utilized, the MVP-0 also
...
Deploy dnation-kubernetes-monitoring-stack with MVP-0 variables:
...
Clone the 'dnation-kubernetes-monitoring' repository (the MVP-0 branch), and
...
Refer to the links of pull requests, branches, or repositories containing MVP-0 related code:
